...
import numpy as np
import os
from utils.common.quaternion import *
...
def recover_pos_from_ric(data, joints_num, hml3d=False):
    r_rot_quat, r_pos = recover_root_rot_pos(data)
    if hml3d:
        # HumanML3D layout: root(4) + ric_data(joints_num*3) + rot_data + ...
        start_indx = 1 + 2 + 1
    else:
        # SnapMogen BVH layout: root(4) + rot_data(joints_num*6) + ric_data + ...
